...
export const STORAGE_KEYS = {
  RESUMES: 'cvmax_resumes',
  ACTIVE_RESUME_ID: 'cvmax_active_resume',
  API_KEY: 'cvmax_api_key',
  API_BASE: 'cvmax_api_base',
  SETTINGS: 'cvmax_settings'
};
...
export function exportResume(resume) {
  ...
  a.href = url;
  a.download = `cvmax_${resume.name || 'resume'}_${Date.now()}.json`;
  a.click();
